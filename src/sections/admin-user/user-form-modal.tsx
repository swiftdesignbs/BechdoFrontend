...
import { apiService, type Image, type CreateUserRequest, type User } from 'src/utils/api-service';
...
interface UserFormModalProps {
  ...
  onClose: () => void;
  onSuccess: () => void;
  editingUser?: User | null; // User to edit (null for create mode)
}
